-- Update the check_availability_date function to automatically set availability_status based on 90-day rule
...
BEGIN
  IF NEW.last_donation_date IS NOT NULL THEN
    ...
    days_since_donation := EXTRACT(DAY FROM (CURRENT_DATE - NEW.last_donation_date));
